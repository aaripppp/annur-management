<div>
    ...
    <div class="flex items-center gap-2 text-body-md text-on-surface-variant mb-3">
        ...
        <span>&rsaquo;</span>
        <a href="{{ route('pembayaran.prospective.show', $payment) }}" class="hover:text-primary transition-colors">{{ $payment->receipt_number }}</a>
        <span>&rsaquo;</span>
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div class="min-w-0">
            ...
            <p class="text-body-md text-on-surface-variant mt-0.5">{{ $payment->receipt_number }} &bull; {{ $payment->prospectiveStudent->nama_lengkap ?? '—' }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div class="lg:col-span-2 flex flex-col gap-6">
            ...
            <!-- Informasi Calon Siswa (Read Only) -->
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
                <div class="px-5 py-4 border-b border-outline-variant bg-surface-container-low">
                    <h2 class="text-headline-sm font-headline-sm text-on-surface">Informasi Calon Siswa</h2>
                </div>
                <div class="p-5 flex items-center gap-4">
                    ...
                    <div>
                        <div class="text-headline-sm font-bold text-on-surface">{{ $payment->prospectiveStudent->nama_lengkap ?? '—' }}</div>
                        <div class="text-body-md text-on-surface-variant">No. Pendaftaran: {{ $payment->prospectiveStudent->registration_number ?? '—' }} &bull; Kelas Tujuan {{ $payment->prospectiveStudent->schoolClass->name ?? '—' }}</div>
                        <div class="text-body-md text-on-surface-variant">Tahun Ajaran Tujuan {{ $payment->prospectiveStudent->academicYear->year ?? '—' }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-surface-container-lowest border border-outline-variant rounded-xl overflow-hidden shadow-sm">
                ...
                <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="description" wire:model.live="description" placeholder="Contoh: Pembayaran Formulir Pendaftaran" maxlength="500" class="w-full py-2.5 px-3 border-outline-variant focus:border-primary focus:ring-primary rounded-lg text-body-md shadow-sm">
            ...
            <div class="flex gap-3">
                <a href="{{ route('pembayaran.prospective.show', $payment) }}" class="px-5 py-2.5 text-on-surface-variant font-label-lg border border-outline-variant rounded-xl hover:bg-surface-container transition-colors">
                    Batal
                </a>
