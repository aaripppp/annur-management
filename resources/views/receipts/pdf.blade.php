...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { margin: 0; padding: 3mm; color: #172033; background: #ffffff; font-family: "DejaVu Sans", sans-serif; font-size: 9px; }
        ...
        .details { padding: 7px 14px 4px; }
        .details-heading { margin-bottom: 4px; color: #64748b; font-size: 7px; font-weight: bold; letter-spacing: .5px; text-transform: uppercase; }
        .payment-table { width: 100%; border-collapse: collapse; page-break-inside: avoid; break-inside: avoid; }
        .details-table th, .details-table td { padding: 4px 5px; border-bottom: 1px solid #e5e9f0; font-size: 8px; }
        ...
        .notes { margin-top: 5px; padding: 5px 6px; border-radius: 5px; background: #f8fafc; color: #64748b; font-size: 8px; page-break-inside: avoid; break-inside: avoid; }
        .notes strong { color: #172033; }
        .receipt-footer { width: 100%; margin-top: 5px; padding: 2px 22px 8px 14px; page-break-inside: avoid; break-inside: avoid; }
