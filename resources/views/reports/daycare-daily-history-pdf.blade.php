...
<head>
    ...
    <title>Riwayat Transaksi Harian Daycare</title>
    <style>
    ...
    <table class="document-header">
        <tr>
            ...
            <td class="title-cell">
                ...
                <div class="title-note">DAYCARE<br>(DAILY TRANSACTION HISTORY)</div>
            </td>
    ...
    <table class="report-table">
        <thead>
            <tr>
                ...
                <th class="col-name">Nama Anak</th>
                <th class="col-class">Unit/Kelas</th>
        ...
        <tbody>
            ...
            @else
                ...
                <tr>
                    ...
                    <td class="col-date">{{ $row['payment_date']->format('d/m/Y') }}</td>
